...
// table from a remote URL (default: the ipguard-geofeed service on Cloudflare R2).
//
// Usage:
//
...
// DefaultURL is the URL of the curated TGEO file published by the
// ipguard-geofeed service. Override with WithURL.
